...
[Website](https://kunal26das.github.io/startup/) · [Quick start](#quick-start) ·
[Android setup](docs/android.md) · [Swift](docs/swift.md) ·
...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("io.github.kunal26das:startup:4.0.2")
        }
    }
}
```
...
Dependency examples use **4.0.2**. See the [changelog](CHANGELOG.md) for fixes and the
